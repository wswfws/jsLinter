...
class CheckEmptyLines(unittest.TestCase):
    def test_empty_lines_present(self):
        ...
        warnings = check_for_empty_lines(code_with_empty_lines, 9)
    ...
    def test_no_empty_lines(self):
        ...
        warnings = check_for_empty_lines(code, 9)
        self.assertEqual(len(warnings), 0)

    def test_many_code_without_empty_lines(self):
        for MAX_CODE_LINES_WITHOUT_EMPTY_LINE in range(1, 10):
            for extra_lines in range(10):
                ...
                warnings = check_for_empty_lines(code_without_empty_lines, MAX_CODE_LINES_WITHOUT_EMPTY_LINE)
